 ...
 */
export const PCSKeys: Record<string, PCSKey | undefined>[] = [
...
PCSKeys[1].ProjStdParallelGeoKey = PCSKeys[0].ProjStdParallel1GeoKey;
PCSKeys[2].ProjOriginLongGeoKey = PCSKeys[1].ProjNatOriginLongGeoKey;
PCSKeys[2].ProjOriginLatGeoKey = PCSKeys[1].ProjNatOriginLatGeoKey;
PCSKeys[2].ProjScaleAtOriginGeoKey = PCSKeys[1].ProjScaleAtNatOriginGeoKey;
