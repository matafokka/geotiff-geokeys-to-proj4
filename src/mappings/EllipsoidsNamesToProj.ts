 ...
 *
 * If this object contains EPSG code, use the value directly.
 *
 * Otherwise, loop over all keys and check if ellipsoid name starts with it. If there're multiple matches, pick one with
 * the greatest length.
 */
export const EllipsoidsNamesToProj: Record<string, string | undefined> = {
