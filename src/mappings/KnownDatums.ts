 ...
 *
 * This should be used only by generators. For all datums, use `GeogGeodeticDatumGeoKey`.
 */
export const KnownDatums: Record<string, string | undefined> = {
  //------------------------------------------------------------------------------------------------------------------//

  // Source: https://gis-lab.info/qa/mapinfo_to_wkt_proj4.html
  // Data has been taken from MapInfo by the authors of that article
  // Same data is present below
  ...
  // Source:
  // https://github.com/chrisveness/geodesy/blob/33d1bf53c069cd7dd83c6bf8531f5f3e0955c16e/latlon-ellipsoidal-datum.js#L54
