import { AdditionalCRS } from "@/mappings/predefined/AdditionalCRS";
import { ARGS } from "@/cli/args";
import { mappingGenerator } from "@/generators/mappingGenerator";
import type { WithEpsgId } from "@/types/misc";
import { parseCsName } from "@/generators/utils/parseCsName";
import { getCsUomInfo } from "@/generators/utils/getCsUomInfo";
...
export const crsGenerator = mappingGenerator<Row, string | number | CRSObj>({
  name: "CRS",
  ...
  dependencies: [datumsGenerator, verticalCsGenerator, unitsGenerator, conversionsGenerator],
